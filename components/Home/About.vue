  ...
  >
    ...
    <div class="w-[58%] max-[1400px]:w-full mr-3">
      ...
      <p class="text-2xl font-normal text-black mt-7">
        ...
        mempersembahkan kekayaan tradisi, seni, dan budaya dari penjuru
        nusantara. Dari kesenian, hidangan otentik, dan masih banyak yang
        lainnya. <br />
        <br />LokaBestari memberi kemudahan bagi Anda untuk mengeksplor dan
        mengedukasi Anda tentang warisan budaya yang ada di Indonesia.
      </p>
    </div>
    <div id="about" class="box-border flex max-[750px]:w-full max-[1000px]:w-[75%] max-[1400px]:w-[50%] w-[30%] justify-end py-[40px]">
      <div class="flex flex-wrap justify-center ">
        <img
          src="~/assets/img/home/about1.png"
          class="max-sm:w-[300px] max-w-[515px] max-h-[610px] rounded-3xl z-10 hover:scale-105 transition-all duration-500 hover:shadow-2xl object-cover"
          alt=""
        />
        <img
          src="~/assets/img/home/about2.png"
          class="max-sm:w-[300px] w-[473px] h-[329px] -mt-[55%] -ml-[15%] z-20 rounded-3xl outline outline-8 outline-[#EFFFF3] hover:outline-none hover:scale-105 transition-all duration-500 hover:shadow-2xl object-cover"
          alt=""
        />
      </div>
    </div>

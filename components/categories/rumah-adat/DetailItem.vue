      ...
      >
        <div class="w-full max-h-full cursor-pointer card-detail">
          <div class="card-detail-image">
            <img
              :src="`/_nuxt/assets/images/rumah-adat/${item.gambar}.png`"
              alt=""
      ...
      <div class="flex flex-col items-center justify-center">
        ...
        >
          <NuxtLink
            ...
            :key="reccomended.id"
            :to="`/kategori/rumah-adat/${reccomended.id}`"
          >
            <img
              :src="`/_nuxt/assets/images/rumah-adat/${reccomended.gambar}.png`"
              alt="nama"
...
import rumahadat from "~/data/rumah-adat.json"

const item = ref({})
const reccomended = ref([])

const getData = () => {
  item.value = rumahadat.filter((data) => data.id == useRoute().params.id)[0]
}
const getReccomended = () => {
  const filteredItem = rumahadat.filter(

<template>
  <section
    class="bg-black h-[90vh] lg:h-[110vh] -mt-[200px] bg-[url('~/assets/images/categoriespage/upacara-adat/hero.png')] bg-center bg-cover"
  >
      ...
      <div class="flex flex-col items-center justify-center h-full mt-20">
        ...
        >
          ...
          <h1 class="mt-2 text-xl lg:text-3xl font-light text-white">
            Jelajahi Upacara Adat otentik nusantara
          </h1>
        </div>
        <NuxtLink
          href="/kategori/upacara_adat/list"

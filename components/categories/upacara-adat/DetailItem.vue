      ...
      >
        <div class="w-full max-h-full cursor-pointer card-detail">
          <div class="card-detail-image">
            <img
              :src="`/_nuxt/assets/images/upacara_adat/${item.gambar}.png`"
              alt=""
      ...
      <div class="flex flex-col items-center justify-center">
        ...
        >
          <NuxtLink
            ...
            :key="reccomended.id"
            :to="`/kategori/upacara_adat/${reccomended.id}`"
          >
            <img
              :src="`/_nuxt/assets/images/upacara_adat/${reccomended.gambar}.png`"
              alt="nama"

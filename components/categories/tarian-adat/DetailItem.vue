      ...
      >
        <div class="w-full max-h-full cursor-pointer card-detail">
          <div class="card-detail-image">
            <img
              :src="`/_nuxt/assets/images/tarian-adat/${item.gambar}.png`"
              alt=""
      ...
      <div class="flex flex-col items-center justify-center">
        ...
        >
          <NuxtLink
            ...
            :key="reccomended.id"
            :to="`/kategori/tarian-adat/${reccomended.id}`"
          >
            <img
              :src="`/_nuxt/assets/images/tarian-adat/${reccomended.gambar}.png`"
              alt="nama"
...
import tarianadat from "~/data/tari-adat.json"

const item = ref({})
const reccomended = ref([])

const getData = () => {
  item.value = tarianadat.filter((data) => data.id == useRoute().params.id)[0]
}
const getReccomended = () => {
  const filteredItem = tarianadat.filter(
